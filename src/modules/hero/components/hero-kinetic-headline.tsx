...
export function HeroKineticHeadline({ hero }: Props) {
	...
	if (reduceMotion) {
		return (
			<h1 className="font-serif text-balance text-4xl leading-[1.08] tracking-tight text-pearl sm:text-5xl lg:text-6xl">
	...
	return (
		<motion.h1
			className="font-serif text-balance text-4xl leading-[1.08] tracking-tight text-pearl sm:text-5xl lg:text-6xl"
			variants={container}
			initial="hidden"
			animate="visible"
		>
